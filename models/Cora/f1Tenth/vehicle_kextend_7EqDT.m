function f = vehicle_kextend_7EqDT(x,u,h)
...
%------------- BEGIN CODE --------------
    ...
    f(1,1) = x(1) + h*(x(4)*cos(x(3)) - x(5)*sin(x(3)));           % x
    f(2,1) = x(2) + h*(x(4)*sin(x(3)) + x(5)*cos(x(3)));           % y
    f(3,1) = x(3) + h*(x(6));                                      % phi
    f(4,1) = x(4) + h*(u(1));                                      % vx
    f(7,1) = x(7) + h*(u(2));                                      % delta
    f(5,1) = x(5) + h*(lr/(lf+lr) * (f(7,1)*x(4) + x(7)*f(4,1)));  % vy
    f(6,1) = x(6) + h*(1/(lf+lr) * (f(7,1)*x(4) + x(7)*f(4,1)));   % w
